...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-12 col-xl-8">
      <?php echo form_open('/admin/kegiatan/'. $kegiatan['id'], ['method' => 'post']); ?>
          ...
          <div class="col-9">
            ...
            >
              ...
              <?php foreach ($kategori as $item) : ?>
                <option 
                  value="<?= $item['id'];?>"
                  <?= $kegiatan['kategori_id'] == $item['id'] ? 'selected' : '';?>
                >
                  <?= $item['nama_kategori'];?>
                </option>
              <?php endforeach; ?>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-9">
            <textarea 
              ...
              rows="10"
            ><?= old('deskripsi_kegiatan') ? old('deskripsi_kegiatan') : $kegiatan['deskripsi_kegiatan'];?></textarea>
            <div class="invalid-feedback">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-9">
            <input 
              ...
              value="<?= old('tanggal_kegiatan') ? old('tanggal_kegiatan') : $kegiatan['tanggal_kegiatan'];?>"
            >
            <div class="invalid-feedback">
        ...
        <div class="mb-3 row">
          ...
          <div class="col-9">
            <input 
              ...
              value="<?= old('batas_pendaftaran') ? old('batas_pendaftaran') : $kegiatan['batas_pendaftaran'];?>"
            >
            <div class="invalid-feedback">
